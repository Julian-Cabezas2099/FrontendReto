...
$.ajax(
                     {
                        ...
                        success      :  function(respuesta){
                            ...
                            for (i=0; i < respuesta.length; i++){
                                  ...
                                  $("#listaCategorias").append("<option value='"+respuesta[i].id+"' id='opcion' >"+respuesta[i].id+" "+ respuesta[i].name+"</option>")
...
//     //                  $("#listaCategorias").append("<option value='"+respuesta[i].id+"' id='opcion' >"+respuesta[i].name+"</option>")
...
//                                 // var idBike= json[i].id;
//                                 var nameCategory= json[i].category.name;
//                                 var marca = json[i].brand;
//                                 var modelo = json[i].year;
//                                 var nombre = json[i].name;
//                                 var descripcion = json[i].description;
...
//                                 $("#res").append("<td>" + descripcion + "</td>");
//                                $("#res").append("<td> <a id='boton' class=\"btn btn-outline-primary\">DETALLES</a></td>");
//                                $("#boton").click(()=>mostrarinfo(nameCategory,marca,modelo,nombre,descripcion));
